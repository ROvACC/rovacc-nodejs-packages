...
export type OutcomeReason = 'completed' | 'terminated';
...
export type Reducer<T = unknown> = (
  training: Training | null,
  event: T
) => Training;
export type IsEmitted<T = unknown> = (
  training: Training | null,
  event: T
) => boolean;
